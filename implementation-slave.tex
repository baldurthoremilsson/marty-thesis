...
The write-ahead log contains all the changes that are made on the master database.
They are stored in binary records that can be applied directly to the files in the slave cluster.
...
\begin{lstlisting}[caption={WAL replay log example},label={lst:wal-replay-log}]
