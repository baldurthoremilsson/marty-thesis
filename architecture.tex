...
\begin{figure}[h!]
  \centering
    \includegraphics[width=0.5\textwidth]{clone-tables}
...
For an example of the schema of a data table see figure \ref{fig:history-data-table}, and for further details see chapter TODO.
